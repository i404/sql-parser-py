...
dataType
    : complex_=ARRAY '<' dataType '>'                            #complex_DataType
    | complex_=MAP '<' dataType ',' dataType '>'                 #complex_DataType
    | complex_=STRUCT ('<' complex_ColTypeList? '>' | NEQ)        #complex_DataType
...
complex_ColTypeList
    : complex_ColType (',' complex_ColType)*
    ;
